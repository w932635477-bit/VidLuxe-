...
(async () => {
  ...
  try {
    ...
    if (pageText.includes('验证邮箱') && pageText.includes('5 次免费额度')) {
      ...
      await page.screenshot({ path: 'e2e-verification-banner.png', fullPage: true });
      console.log('  截图: e2e-verification-banner.png\n');
      ...
      await page.screenshot({ path: 'e2e-after-send.png', fullPage: true });
      console.log('  截图: e2e-after-send.png\n');
